...
namespace Haram.RemittanceSystem.Migrations
{
    ...
    [Migration("20240406104720_modifyRemittanceWithReceiverInfo2")]
    partial class modifyRemittanceWithReceiverInfo2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Haram.RemittanceSystem.Currencies.Currency", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Haram.RemittanceSystem.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RemittanceSystemCustomers", (string)null);
                });

            modelBuilder.Entity("Haram.RemittanceSystem.Remittances.Remittance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ReceiverLirstName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("RemittanceSystemRemittance", (string)null);
                });

            modelBuilder.Entity("Haram.RemittanceSystem.Statuses.Status", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RemittanceSystemStatuses", (string)null);
                });
            ...
            modelBuilder.Entity("Haram.RemittanceSystem.Remittances.Remittance", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedByID");

                    b.HasOne("Haram.RemittanceSystem.Currencies.Currency", "currency")
                        .WithMany("remittances")
                        .HasForeignKey("CurrencyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Volo.Abp.Identity.IdentityUser", "IssuedBy")
                        .WithMany()
                    ...
                    b.HasOne("Haram.RemittanceSystem.Customers.Customer", "Sender")
                        .WithMany("SendedRemittances")
            ...
            modelBuilder.Entity("Haram.RemittanceSystem.Statuses.Status", b =>
                {
                    b.HasOne("Haram.RemittanceSystem.Remittances.Remittance", "remittance")
                        .WithMany("Statuses")
            ...
            modelBuilder.Entity("Haram.RemittanceSystem.Customers.Customer", b =>
                {
                    ...
                    b.Navigation("SendedRemittances");
                });
