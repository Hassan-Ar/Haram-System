...
namespace Haram.RemittanceSystem.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RemittanceSystemCurrencies",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AlphabeticCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RemittanceSystemCurrencies", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "RemittanceSystemCustomers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    CustGender = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RemittanceSystemCustomers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RemittanceSystemRemittance",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RemittanceSystemRemittance", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RemittanceSystemRemittance_AbpUsers_ApprovedByID",
                        column: x => x.ApprovedByID,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RemittanceSystemRemittance_AbpUsers_IssuedById",
                        column: x => x.IssuedById,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RemittanceSystemRemittance_AbpUsers_ReleasedById",
                        column: x => x.ReleasedById,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RemittanceSystemRemittance_RemittanceSystemCurrencies_CurrencyID",
                        column: x => x.CurrencyID,
                        principalTable: "RemittanceSystemCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_remittances_customers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "RemittanceSystemCustomers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_remittances_customers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "RemittanceSystemCustomers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RemittanceSystemStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RemittanceSystemStatuses_RemittanceSystemRemittance_RemittanceId",
                        column: x => x.RemittanceId,
                        principalTable: "RemittanceSystemRemittance",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemCurrencies_AlphabeticCode",
                table: "RemittanceSystemCurrencies",
                column: "AlphabeticCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemRemittance_ApprovedByID",
                table: "RemittanceSystemRemittance",
                column: "ApprovedByID");

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemRemittance_CurrencyID",
                table: "RemittanceSystemRemittance",
                column: "CurrencyID");

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemRemittance_IssuedById",
                table: "RemittanceSystemRemittance",
                column: "IssuedById");

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemRemittance_ReceiverId",
                table: "RemittanceSystemRemittance",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemRemittance_ReleasedById",
                table: "RemittanceSystemRemittance",
                column: "ReleasedById");

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemRemittance_SenderId",
                table: "RemittanceSystemRemittance",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_RemittanceSystemStatuses_RemittanceId",
                table: "RemittanceSystemStatuses",
                column: "RemittanceId");
        }
